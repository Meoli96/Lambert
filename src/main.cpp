...
int main() {
    ...
    std::cout << "Computing departure days.." << std::endl;
    ...
    // Compute deltaV
    std::cout << "Computing deltaV.." << std::endl;
    double res_v, res_m;
    computeDV(0, 0, dep_span, trav_span, res_v, res_m);
    std::cout << "Done!" << std::endl;
